...
def frame_to_time(start_frame, end_frame, r_frame_rate):
    ...
    end_time = _to_float(Decimal(end_frame - 1) * r_frame_rate_denom / r_frame_rate_numer)
...
def time_to_frame(start_time, end_time, r_frame_rate):
    ...
    end_frame = _to_int(Decimal(end_time) * r_frame_rate_numer / r_frame_rate_denom) + 1
