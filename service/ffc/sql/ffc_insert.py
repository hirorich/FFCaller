...
def insert_trim(conn, trim_entity):
    ...
    query.append(r'(target_id, start_time, trim_duration, start_frame, end_frame, frame_input_flag, video_fade_in, video_fade_out, audio_fade_in, audio_fade_out)')
    query.append(r'VALUES')
    query.append(r'(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)')
    param = (trim_entity.target_id, trim_entity.start_time, trim_entity.trim_duration, trim_entity.start_frame, trim_entity.end_frame, trim_entity.frame_input_flag, trim_entity.video_fade_in, trim_entity.video_fade_out, trim_entity.audio_fade_in, trim_entity.audio_fade_out)
